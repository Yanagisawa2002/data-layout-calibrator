...
namespace Yanagisawa.DataLayoutCalibrator.Benchmark.Editor
{
    ...
    /// </summary>
    public static class DataLayoutCalibratorBuild
    {
        private const string SceneAssetPath =
            "Assets/DataLayoutCalibrator/Generated/DataLayoutCalibrator.unity";

        private const string ExecutableName = "DataLayoutCalibrator.exe";
        private const string BackendArgument = "-dla-backend";

        [MenuItem("Tools/Data Layout Calibrator/Generate Benchmark Scene")]
        public static void GenerateBenchmarkScene()
        {
            ...
            var marker = new GameObject("Data Layout Calibrator (runtime bootstrap)");
        ...
        [MenuItem("Tools/Data Layout Calibrator/Build Windows x64/Mono Smoke")]
        ...
        [MenuItem("Tools/Data Layout Calibrator/Build Windows x64/IL2CPP Formal")]
        ...
        private static void VerifyBurstAotArtifacts(string outputDirectory)
        {
            ...
            string[] requiredEntrypoints =
            {
                ...
                "ParticleSoAExportJob",
                "ParticleAoSoA8IngressJob",
                "ParticleAoSoA8ExportJob",
