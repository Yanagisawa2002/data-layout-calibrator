...
task_stage="$task_root/build-stage-03"
mkdir "$task_stage"
...
cd "$task_root"
printf '%s\n' '64c1c63a7b04d6c9f2a1e5ae1895a2976b9ec8f11c47696c3d0fc0058443467f  source-linux-03.tar.gz' | sha256sum --check
mkdir source-linux-03
tar -xzf source-linux-03.tar.gz -C source-linux-03
